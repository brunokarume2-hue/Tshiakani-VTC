...
# Script complet pour configurer Railway en une fois
...
# Configurer les variables Twilio
echo "📝 Configuration des variables Twilio..."
echo ""

railway variables set TWILIO_ACCOUNT_SID=AC80018f519898d589fc4e9f07f79e0327 2>&1 | grep -v "already exists" || true
railway variables set TWILIO_AUTH_TOKEN=PF6AMX1753UD629JDFF1D7GE 2>&1 | grep -v "already exists" || true
