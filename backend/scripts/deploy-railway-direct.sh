...
# Déploiement direct avec connection string complète

set -e

echo "🚂 Déploiement Railway - Mode Direct"
echo "====================================="
echo ""
...
# Demander la connection string complète
echo "📋 Connection string Supabase"
echo ""
echo "Template : postgresql://postgres:[PASSWORD]@db.ecayztndohyyjaynrkaz.supabase.co:5432/postgres"
echo ""
read -p "Entrez la connection string complète (avec le mot de passe) : " DATABASE_URL
